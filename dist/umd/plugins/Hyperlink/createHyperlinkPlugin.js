(function(global, factory) {
    if (typeof module === "object" && typeof module.exports === "object") factory(exports, require("react"), require("@contentful/rich-text-types"), require("is-hotkey"), require("../../helpers/editor"), require("../../helpers/transformers"), require("./components/EntityHyperlink"), require("./components/ResourceHyperlink"), require("./components/UrlHyperlink"), require("./HyperlinkModal"), require("./utils"));
        ...
        "./components/EntityHyperlink",
        "./components/ResourceHyperlink",
        "./components/UrlHyperlink",
        "./HyperlinkModal",
        "./utils"
    ], factory);
    else if (global = typeof globalThis !== "undefined" ? globalThis : global || self) factory(global.createHyperlinkPlugin = {}, global.react, global.richTextTypes, global.isHotkey, global.editor, global.transformers, global.entityHyperlink, global.resourceHyperlink, global.urlHyperlink, global.hyperlinkModal, global.utils);
})(this, function(exports, _react, _richtexttypes, _ishotkey, _editor, _transformers, _EntityHyperlink, _ResourceHyperlink, _UrlHyperlink, _HyperlinkModal, _utils) {
    "use strict";
