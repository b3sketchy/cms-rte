(function(global, factory) {
    if (typeof module === "object" && typeof module.exports === "object") factory(exports, require("@contentful/rich-text-types"), require("is-hotkey"), require("../../helpers/config"), require("../../helpers/editor"), require("../../helpers/sdkNavigatorSlideIn"), require("../../internal"));
    ...
    else if (global = typeof globalThis !== "undefined" ? globalThis : global || self) factory(global.embeddedBlockUtil = {}, global.richTextTypes, global.isHotkey, global.config, global.editor, global.sdkNavigatorSlideIn, global.internal);
})(this, function(exports, _richtexttypes, _ishotkey, _config, _editor, _sdkNavigatorSlideIn, _internal) {
    "use strict";
