(function(global, factory) {
    if (typeof module === "object" && typeof module.exports === "object") factory(exports, require("react"), require("@contentful/rich-text-types"), require("../../helpers/editor"), require("../../helpers/validations"), require("../../internal/queries"), require("../../internal/transforms"), require("./constants"), require("./utils/createInlineEntryNode"), require("./utils/fetchAssets"), require("./utils/fetchEntries"), require("./utils/insertBlock"));
        ...
        "../../internal/transforms",
        "./constants",
        "./utils/createInlineEntryNode",
        "./utils/fetchAssets",
        "./utils/fetchEntries",
        "./utils/insertBlock"
    ], factory);
    else if (global = typeof globalThis !== "undefined" ? globalThis : global || self) factory(global.useCommands = {}, global.react, global.richTextTypes, global.editor, global.validations, global.queries, global.transforms, global.constants, global.createInlineEntryNode, global.fetchAssets, global.fetchEntries, global.insertBlock);
})(this, function(exports, _react, _richtexttypes, _editor, _validations, _queries, _transforms, _constants, _createInlineEntryNode, _fetchAssets, _fetchEntries, _insertBlock) {
    "use strict";
