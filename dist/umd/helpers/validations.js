/* eslint-disable you-dont-need-lodash-underscore/find */ (function(global, factory) {
    if (typeof module === "object" && typeof module.exports === "object") factory(exports, require("@contentful/rich-text-types"), require("lodash/find"), require("lodash/flow"), require("lodash/get"));
    ...
    else if (global = typeof globalThis !== "undefined" ? globalThis : global || self) factory(global.validations = {}, global.richTextTypes, global.find, global.flow, global.get);
})(this, function(exports, _richtexttypes, _find, _flow, _get) {
    "use strict";
